...
public class AttendenceConvertor
        extends
        AEntityConvertor<AttendencePb, AttendencePb.Builder, AttendencePbProvider, AttendenceSearchReqPb,AttendenceSearchReqPb.Builder, AttendenceSearchRespPb,AttendenceSearchRespPb.Builder, AttendenceSearchPbProvider> {
