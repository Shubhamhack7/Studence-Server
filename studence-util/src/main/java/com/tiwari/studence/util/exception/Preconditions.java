...
public class Preconditions {
  ...
  public static void checkWithString(boolean acceptableCond, String... args) {
    if (!acceptableCond) {
      throw new LoggedRuntimeException(new Throwable(), args);
    }
  }

  public static void validateWithUiErrorString(boolean acceptableCond, String uiErrorString,
