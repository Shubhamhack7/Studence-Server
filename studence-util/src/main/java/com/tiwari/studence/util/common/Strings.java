...
public class Strings {
  ...
  /**
   * This should be used only for ascii kind of strings. Not for short form of PB
   *
   * @param str
   * @return
   */
  ...
  public static List<String> getList(String stringValue,String split) {
    String[] splitarr = stringValue.split(split);
  ...
  public static String join(List<String> strings, String join, boolean islower) {
    StringBuilder sb = new StringBuilder();
    for (int i = 0; i < strings.size(); i++) {
      if (i != 0) {
        sb.append(join);
      ...
      if (islower) {
        sb.append(strings.get(i).toLowerCase());
      } else {
        sb.append(strings.get(i));
      }
    }
  ...
  public static String join(String join,boolean islower, String... strings) {
    return join(Arrays.asList(strings), join,islower);
  }
  ...
  public static String getLowerCaseList(String str) {
