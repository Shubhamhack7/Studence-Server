...
public class LoggedRuntimeException extends RuntimeException {
  ...
  public LoggedRuntimeException(String serviceCode, String errorCode, String uiErrorString,
    ...
    if (e != null) {
      if (e instanceof LoggedRuntimeException) {
        m_args.add("Caused by LoggedRuntimeException@"
      ...
      m_args.add("Wrapped LoggedRuntimeException@"
