...
@Singleton
public class ClassesService extends
        AEntityService<ClassesPb, ClassesSearchReqPb, ClassesSearchReqPb.Builder, ClassesSearchRespPb, ClassesPb.Builder, ClassesProvider, ClassesSearchRespPb.Builder, ClassesSearchReqRespProvider, ClassesIndexer, ClassesUpdater, ClassesConverter, ClassesSearcher, ClassesTableNameProvider>
        implements IClassesService {

  @Inject
  public ClassesService(ClassesSearcher searcher, ClassesUpdater updator,
          ClassesConverter convertor, ClassesProvider builderProvder,
          ClassesSearchReqRespProvider requestBuilderprovider,
