	...
	public enum ReqTypeEnum {
	  ...
	  private static class GetByExternalIdHelper implements IReqTypeHelper {
	    ...
	    public boolean isReqOfType(HttpServletRequest req) {
	      ...
	      return pathInfo != null && pathInfo.length() > length
	              && pathInfo.substring(0, length).equals(EXTERNAL_ID_PATH_FOR_GET)
	  ...
	  private static class CreateHelper implements IReqTypeHelper {
	    ...
	    public boolean isReqOfType(HttpServletRequest req) {
	      String methodName = req.getMethod();
	      return !GET_OR_CREATE_LIST_BY_EXTERNALIDPB_LIST.isReqOfType(req)
	              && !SAFE_CREATE_OR_GET_BY_EXTERNAL_ID.isReqOfType(req)
	              && !GET_OR_CREATE_BY_EXTERNALIDPB.isReqOfType(req) && !IMPORT.isReqOfType(req)
	              && HttpRequestMethodEnum
	                      .getHttpRequestMethodEnum(methodName) == HttpRequestMethodEnum.POST;
	    }
	  ...
	  private static class UpdateHelper implements IReqTypeHelper {
	    ...
	    public boolean isReqOfType(HttpServletRequest req) {
	      ...
	      return HttpRequestMethodEnum
	              .getHttpRequestMethodEnum(methodName) == HttpRequestMethodEnum.PUT;
	    }
	  ...
	  private static class DeleteHelper implements IReqTypeHelper {
	    ...
	    public boolean isReqOfType(HttpServletRequest req) {
	      String methodName = req.getMethod();
	      return HttpRequestMethodEnum
	              .getHttpRequestMethodEnum(methodName) == HttpRequestMethodEnum.DELETE;
	    }
	  ...
	  private static class GetOrCreateByExternalIdHelper implements IReqTypeHelper {
	    ...
	    public boolean isReqOfType(HttpServletRequest req) {
	      ...
	      return pathInfo != null && pathInfo.length() > length
	              && pathInfo.substring(0, length).equals(m_path) && HttpRequestMethodEnum
	                      .getHttpRequestMethodEnum(methodName) == HttpRequestMethodEnum.GET;
	    }
	  ...
	  private static class SafeCreateOrGetByExternalIdHelper implements IReqTypeHelper {
	    ...
	    public boolean isReqOfType(HttpServletRequest req) {
	      ...
	      return pathInfo != null && pathInfo.length() == length
	              && pathInfo.substring(0, length).equals(EXTERNAL_ID_PATH_FOR_SAFE_CREATE_OR_GET)
	              && HttpRequestMethodEnum
	                      .getHttpRequestMethodEnum(methodName) == HttpRequestMethodEnum.POST;
	    }
