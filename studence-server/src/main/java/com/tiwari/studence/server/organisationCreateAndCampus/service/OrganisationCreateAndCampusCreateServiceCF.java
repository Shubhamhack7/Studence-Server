...
public class OrganisationCreateAndCampusCreateServiceCF extends
        AControlFlow<OrganisationCreateAndCampusCreateServiceCF.State, OrganisationCreateAndCampusCreatePb, ErrorException> {
  ...
  public OrganisationCreateAndCampusCreateServiceCF(OrganisationCreateAndCampusCreatePb request) {
