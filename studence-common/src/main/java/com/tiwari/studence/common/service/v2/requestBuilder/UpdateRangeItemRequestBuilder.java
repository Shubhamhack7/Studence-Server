...
@Singleton
public class UpdateRangeItemRequestBuilder<T extends ITables>
        extends AUpdateRangeItemRequestBuilder<PutItemRequest> {
  @Inject
  public UpdateRangeItemRequestBuilder(RawDataPartitioner<T, DynamoDbInfo> rawDataPartitioner) {
  ...
  protected PutItemRequest createUpdateItemRequest(String tableName, String expectedVersion,
    ...
    request.withTableName(tableName).withItem(data).addExpectedEntry(
            EntityIndexAttributes.VERSION.name(),
