...
public class GetLargestCF<Pb extends GeneratedMessageV3> extends
        AControlFlow<GetLargestCF.State, Pair<SearchResultSummaryUiPb, List<Pb>>, VoidException> {
  ...
  public GetLargestCF(DynamoDbTableInfo<?> dbInfo, ISecondaryIndexEntity secondaryIndexEntity,
          RangeRequestBuilder getRequestBuilder, RangeResultHandler<Pb, ?> getResultHandler,
          String id, String rangeKey, boolean includeMatch,
          TablePartitionInfoUiPb tablePartitionInfoUiPb, PaginationRequestUiPb pagination,
    ...
    m_tablePartitionInfo = tablePartitionInfoUiPb;
  ...
  private class LookupStoreHandler implements StateHandler<State> {
    ...
    public void registerCalls() {
      Pair<String, PaginationRequestUiPb> partitionKeyAndPagination = m_tablePartitioner
              .getPartitionKeyAndPagination(m_tablePartitionInfo, m_pagination, false);
      ...
      m_request = m_getRequestBuilder.createLargestRequest(tableClientAndName.getSecond(),
