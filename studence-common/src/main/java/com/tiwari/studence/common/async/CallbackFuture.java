...
public class CallbackFuture<R, K extends Exception> extends DoneLatch
	...
	public R get() throws K {
		...
		if (m_exception != null) {
			...
			LoggedRuntimeException stackTraceExp = new LoggedRuntimeException(m_exception, m_exceptionLogInfo);
		...
		if (m_errors != null) {
			...
			LoggedRuntimeException stackTraceExp = new LoggedRuntimeException(m_errors, m_exceptionLogInfo);
