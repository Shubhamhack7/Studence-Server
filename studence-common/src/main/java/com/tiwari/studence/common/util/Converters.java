...
import com.tiwari.studence.common.service.v2.encoder.Base64IntegerEncoder;
...
public class Converters {
  ...
  public static <F, T> IFuture<List<T>, ErrorException> asyncListConvert(
          final IAsyncConverter<F, T> converter, List<F> fromList) {
