...
@Singleton
public class SearchItemCF extends
        AControlFlow<SearchItemCF.State, Pair<Set<Map.Entry<String, AttributeValue>>, List<Map<String, AttributeValue>>>, ErrorException> {
  ...
  public SearchItemCF(String tableName, SearchRequestsPb attributeValues,
          SearchItemInDynamoDbTable searchItemInDynamoDbTable, DynamoDBSearchHelper helper,
  ...
  public class SearchInDynamoDB implements StateHandler<State> {
    Pair<Set<Map.Entry<String, AttributeValue>>, List<Map<String, AttributeValue>>> m_future = null;
    ...
    public State handleState() {
      try {
        ...
        dynamoDbSearchPb.setNextToken(
                new JsonBaseEncoderDecoder().reverseConvert(m_attributeValues.getNextToken()));
